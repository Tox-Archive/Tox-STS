...
* [Program data] (#program-data)
  ...
  * [User profiles] (#user-profiles)
    ...
    * [Encryption] (#user-profile-encryption)
* [User data] (#user-data)
  * [Tox ID] (#tox-id)
...
* [Communication] (#communication)
  ...
  * [Multimedial communication] (#multimedial-communication)
  * [Group communication] (#group-communication)
* [Client interface] (#client-interface)
  * [Words and terms] (#words-and-terms)
    * [Friends and contacts] (#friends-and-contacts)
...
"Friend" is the term used within the toxcore source code for the contacts in user's friend list. However, clients should call them "contacts", since that is more correct and less misleading for the user.
